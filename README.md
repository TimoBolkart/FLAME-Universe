...
- [SEGA: Drivable 3D Gaussian Head Avatar from a Single Image](https://arxiv.org/abs/2504.14373).
...
- [Perceptually Accurate 3D Talking Head Generation: New Definitions, Speech-Mesh Representation, and Evaluation Metrics (CVPR 2025)](https://arxiv.org/abs/2503.20308).
- [DualTalk: Dual-Speaker Interaction for 3D Talking Head Conversations (CVPR 2025)](https://arxiv.org/abs/2505.18096).
- [Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance (CVPR 2025)](https://arxiv.org/abs/2501.05379).
- [RGBAvatar: Reduced Gaussian Blendshapes for Online Modeling of Head Avatars (CVPR 2025)](https://arxiv.org/abs/2503.12886).
- [Coherent 3D Portrait Video Reconstruction via Triplane Fusion (CVPR 2025)](https://arxiv.org/abs/2412.08684).
- [ControlFace: Harnessing Facial Parametric Control for Face Rigging (CVPR 2025)](https://arxiv.org/abs/2412.01160).
- [GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion (CVPR 2025)](https://arxiv.org/abs/2412.10209).
...
- [FATE: Full-head Gaussian Avatar with Textural Editing from Monocular Video (CVPR 2025)](https://arxiv.org/abs/2411.15604).
- [Gaussian Eigen Models for Human Heads (CVPR 2025)](https://arxiv.org/abs/2407.04545).
- [Electromyography-Informed Facial Expression Reconstruction for Physiological-Based Synthesis and Analysis (CVPR 2025)](https://arxiv.org/abs/2503.09556).
- [CAP4D: Creating Animatable 4D Portrait Avatars with Morphable Multi-View Diffusion Models (CVPR 2025)](https://arxiv.org/abs/2412.12093).
- [OFER: Occluded Face Expression Reconstruction (CVPR 2025)](https://arxiv.org/abs/2410.21629).
- [Gaussian Déjà-vu: Creating Controllable 3D Gaussian Head-Avatars with Enhanced Generalization and Personalization Abilities (WACV 2025)](https://arxiv.org/abs/2409.16147).
- [EmoVOCA: Speech-Driven Emotional 3D Talking Heads (WACV 2025)](https://arxiv.org/abs/2403.12886).
- [DEEPTalk: Dynamic Emotion Embedding for Probabilistic Speech-Driven 3D Face Animation (AAAI 2025)](https://arxiv.org/abs/2408.06010).
...
- [ProbTalk3D: Non-Deterministic Emotion Controllable Speech-Driven 3D Facial Animation Synthesis Using VQ-VAE (SIGGRAPH MIG 2024)](https://arxiv.org/abs/2409.07966).
- [GGHead: Fast and Generalizable 3D Gaussian Heads (SIGGRAPH Asia 2024)](https://arxiv.org/abs/2406.09377).- 
- [Generalizable and Animatable Gaussian Head Avatar (NeurIPS 2024)](https://arxiv.org/abs/2410.07971).
- [SPARK: Self-supervised Personalized Real-time Monocular Face Capture (SIGGRAPH Asia 2024)](https://arxiv.org/abs/2409.07984).
- [MultiTalk: Enhancing 3D Talking Head Generation Across Languages with Multilingual Video Dataset (INTERSPEECH 2024)](https://arxiv.org/abs/2406.14272).
- [GPAvatar: Generalizable and Precise Head Avatars from Image(S) (ICLR 2024)](https://arxiv.org/abs/2401.10215).
- [LightAvatar: Efficient Head Avatar as Dynamic Neural Light Field (ECCV-W 2024)](https://arxiv.org/abs/2409.18057).
- [Stable Video Portraits (ECCV 2024)](https://arxiv.org/abs/2409.18083).
- [GRAPE: Generalizable and Robust Multi-view Facial Capture (ECCV 2024](https://arxiv.org/abs/2407.10193).
- [Human Hair Reconstruction with Strand-Aligned 3D Gaussians (ECCV 2024)](https://arxiv.org/abs/2409.14778).
- [PAV: Personalized Head Avatar from Unstructured Video Collection (ECCV 2024)](https://arxiv.org/abs/2407.21047).
- [GAUSSIAN3DIFF: 3D Gaussian Diffusion for 3D Full Head Synthesis and Editing (ECCV 2024)](https://arxiv.org/abs/2312.03763.pdf).
- [MeGA: Hybrid Mesh-Gaussian Head Avatar for High-Fidelity Rendering and Head Editing (ECCV 2024)](https://arxiv.org/abs/2404.19026).
- [HeadGaS: Real-Time Animatable Head Avatars via 3D Gaussian Splatting (ECCV 2024)](https://arxiv.org/abs/2312.02902).
- [HeadStudio: Text to Animatable Head Avatars with 3D Gaussian Splatting (ECCV 2024)](https://arxiv.org/abs/2402.06149).
- [3D Gaussian Blendshapes for Head Avatar Animation (SIGGRAPH 2024)](https://arxiv.org/abs/2404.19398).
- [MonoGaussianAvatar: Monocular Gaussian Point-based Head Avatar (SIGGRAPH 2024)](https://arxiv.org/abs/2312.04558).
- [DiffPoseTalk: Speech-Driven Stylistic 3D Facial Animation and Head Pose Generation via Diffusion Models (SIGGRAPH 2024)](https://arxiv.org/abs/2310.00434).
- [EMAGE: Towards Unified Holistic Co-Speech Gesture Generation via Expressive Masked Audio Gesture Modeling (CVPR 2024)](https://arxiv.org/abs/2401.00374).
- [UltrAvatar: A Realistic Animatable 3D Avatar Diffusion Model with Authenticity Guided Textures (CVPR 2024)](https://arxiv.org/abs/2401.11078).
- [FlashAvatar: High-fidelity Head Avatar with Efficient Gaussian Embedding (CVPR 2024)](https://arxiv.org/abs/2312.02214).
- [Portrait4D: Learning One-Shot 4D Head Avatar Synthesis using Synthetic Data (CVPR 2024)](https://arxiv.org/abs/2311.18729).
- [SplattingAvatar: Realistic Real-Time Human Avatars with Mesh-Embedded Gaussian Splatting (CVPR 2024)](https://arxiv.org/abs/2403.05087).
- [3D Facial Expressions through Analysis-by-Neural-Synthesis (CVPR 2024)](https://arxiv.org/abs/2404.04104).
- [GaussianAvatars: Photorealistic Head Avatars with Rigged 3D Gaussians (CVPR 2024)](https://arxiv.org/abs/2312.02069).
...
- [Feel the Bite: Robot-Assisted Inside-Mouth Bite Transfer using Robust Mouth Perception and Physical Interaction-Aware Control (HRI 2024)](https://dl.acm.org/doi/abs/10.1145/3610977.3634975).
- [ReliTalk: Relightable Talking Portrait Generation from a Single Video (IJCV 2024)](https://arxiv.org/abs/2309.02434).
...
- [Towards Realistic Generative 3D Face Models (WACV 2024)](https://arxiv.org/abs/2304.12483).
- [LaughTalk: Expressive 3D Talking Head Generation with Laughter (WACV 2024)](https://arxiv.org/abs/2311.00994).
- [NeRFlame: FLAME-based conditioning of NeRF for 3D face rendering (ICCS 2024)](https://arxiv.org/abs/2303.06226).

#### 2023

- [A Large-Scale 3D Face Mesh Video Dataset via Neural Re-parameterized Optimization](https://arxiv.org/abs/2310.03205).
- [DF-3DFace: One-to-Many Speech Synchronized 3D Face Animation with Diffusion](https://arxiv.org/abs/2310.05934)
...
- [Articulated 3D Head Avatar Generation using Text-to-Image Diffusion Models](https://arxiv.org/abs/2307.04859).
- [Fake It Without Making It: Conditioned Face Generation for Accurate 3D Face](https://arxiv.org/abs/2307.13639).
- [Text2Face: A Multi-Modal 3D Face Model](https://arxiv.org/abs/2303.02688).
- [SelfTalk: A Self-Supervised Commutative Training Diagram to Comprehend 3D Talking Faces (ACM-MM 2023)](https://arxiv.org/abs/2306.10799).
- [Expressive Speech-driven Facial Animation with controllable emotions (ICMEW 2023)](https://arxiv.org/abs/2301.02008).
...
- [Emotional Speech-Driven Animation with Content-Emotion Disentanglement (SIGGRAPH Asia 2023)](https://arxiv.org/abs/2306.08990).
...
- [Neural Haircut: Prior-Guided Strand-Based Hair Reconstruction (ICCV 2023)](https://arxiv.org/abs/2306.05872).
- [Can Language Models Learn to Listen? (ICCV 2023)](https://arxiv.org/abs/2308.10897).
...
- [Semantify: Simplifying the Control of 3D Morphable Models using CLIP (ICCV 2023)](https://arxiv.org/abs/2308.07415).
...
- [High-Res Facial Appearance Capture from Polarized Smartphone Images (CVPR 2023)](https://arxiv.org/abs/2212.01160).
- [Instant Volumetric Head Avatars (CVPR 2023)](https://arxiv.org/abs/2211.12499).
- [Learning Personalized High Quality Volumetric Head Avatars (CVPR 2023)](https://arxiv.org/abs/2304.01436).
- [Next3D: Generative Neural Texture Rasterization for 3D-Aware Head Avatars (CVPR 2023)](https://arxiv.org/abs/2211.11208).
- [PointAvatar: Deformable Point-based Head Avatars from Videos (CVPR 2023)](https://arxiv.org/abs/2212.08377).
- [Visual Speech-Aware Perceptual 3D Facial Expression Reconstruction from Videos (CVPR-W 2023)](https://arxiv.org/abs/2207.11094).
- [Scaling Neural Face Synthesis to High FPS and Low Latency by Neural Caching (WACV 2023)](https://arxiv.org/abs/2211.05773).
...
- [Realistic One-shot Mesh-based Head Avatars (ECCV 2022)](https://arxiv.org/abs/2206.08343).
- [Towards Metrical Reconstruction of Human Faces (ECCV 2022)](https://arxiv.org/abs/2204.06607).
- [Towards Racially Unbiased Skin Tone Estimation via Scene Disambiguation (ECCV 2022)](https://arxiv.org/abs/2205.03962).
- [Generative Neural Articulated Radiance Fields (NeurIPS 2022)](https://arxiv.org/abs/2206.14314).
- [EMOCA: Emotion Driven Monocular Face Capture and Animation (CVPR 2022)](https://arxiv.org/abs/2204.11312).
- [Generating Diverse 3D Reconstructions from a Single Occluded Face Image (CVPR 2022)](https://arxiv.org/abs/2112.00879).
- [I M Avatar: Implicit Morphable Head Avatars from Videos (CVPR 2022)](https://arxiv.org/abs/2112.07471).
- [Learning to Listen: Modeling Non-Deterministic Dyadic Facial Motion (CVPR 2022)](https://arxiv.org/abs/2204.08451).
- [Neural Emotion Director: Speech-preserving semantic control of facial expressions in “in-the-wild” videos (CVPR 2022)](https://arxiv.org/abs/2112.00585).
- [Neural head avatars from monocular RGB videos (CVPR 2022)](https://arxiv.org/abs/2112.01554).
- [RigNeRF: Fully Controllable Neural 3D Portraits (CVPR 2022)](https://arxiv.org/abs/2206.06481).
- [Simulated Adversarial Testing of Face Recognition Models (CVPR 2022)](https://arxiv.org/abs/2106.04569).
- [Accurate 3D Hand Pose Estimation for Whole-Body 3D Human Mesh Estimation (CVPR-W 2022)](https://arxiv.org/abs/2011.11534).
- [MOST-GAN: 3D Morphable StyleGAN for Disentangled Face Image Manipulation (AAAI 2022)](https://arxiv.org/abs/2111.01048).
...
- [MorphGAN: One-Shot Face Synthesis GAN for Detecting Recognition Bias (BMVC 2021)](https://arxiv.org/abs/2012.05225).
- [SIDER : Single-Image Neural Optimization for Facial Geometric Detail Recovery (3DV 2021)](https://arxiv.org/abs/2108.05465).
- [SAFA: Structure Aware Face Animation (3DV 2021)](https://arxiv.org/abs/2111.04928).
- [Learning an Animatable Detailed 3D Face Model from In-The-Wild Images (SIGGRAPH 2021)](https://arxiv.org/abs/2012.04012).

#### 2020

- [Monocular Expressive Body Regression through Body-Driven Attention (ECCV 2020)](https://arxiv.org/abs/2008.09062).
- [GIF: Generative Interpretable Faces (3DV 2020)](https://arxiv.org/abs/2009.00149).

#### 2019

- [Learning to Regress 3D Face Shape and Expression from an Image without 3D Supervision (CVPR 2019)](https://arxiv.org/abs/1905.06817).
